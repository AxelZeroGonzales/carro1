...
extends JPanel
implements MouseListener, TableModel, ActionListener
{
	private static final String SET_VEL = "asignarVelocidad";
	  ...
	  public TrackPanel(Instanciacion i)
	  {
	    ...
	    JMenuItem color = new JMenuItem("asignarColor");
	    color.addActionListener(this);
	    color.setActionCommand("COLOR");
	    this.carroMnu.add(color);
	    
	    JMenuItem velocidad = new JMenuItem("asignarVelocidad");
	    velocidad.addActionListener(this);
	    velocidad.setActionCommand("VELOCIDAD");
	    this.carroMnu.add(velocidad);
	    
	    JMenuItem gasolina = new JMenuItem("asignarGasolina");
	  ...
	  protected void changeSelectedColor()
	  {
	    ...
	    if (respuesta == 0)
	    {
	      try
	      {
	        ...
	        int g = Integer.parseInt(gTxt.getText());
	      ...
	      {
	        JOptionPane.showMessageDialog(this, "Error en los parámetros de la invocación del método", 
	          "Error de creación de nueva instancia", 0); return;
	      }
	      int b=0;
	      int g=0;
	      int r=0;
	  ...
	  private Object rowValue(int rowIndex)
	  {
	    ...
	    if (this.selected != null) {
	      ...
	      case 1: 
	        ...
	        break;
	      case 2: 
	        retVal = retVal + "(" + this.selected.darAutomovil().darColor().getRed() + "," + this.selected.darAutomovil().darColor().getGreen() + "," + this.selected.darAutomovil().darColor().getBlue() + ")";
	        break;
	      case 3: 
	        retVal = retVal + (int)this.selected.getPosicion().getX() + "," + (int)this.selected.getPosicion().getY();
	      }
	    }
	    return retVal;
	  }
